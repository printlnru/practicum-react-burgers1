...
export default function ResetPasswordPage() {
    ...
    if (!!!forgotDate || diffMins > 1) { //2 минуты на восстановление
        return (
    ...
    return (
        <div className={styles.container}>
            <form onSubmit={handleSubmit}>
                ...
                <div className='pb-6'>
                    <PasswordInput placeholder={"Введите новый пароль"} onChange={handleChange} name={"password"} value={state.password} />
                </div>

                <div className='pb-6'>
                    <Input type={"text"} placeholder={"Введите код из письма"} onChange={handleChange} name={"token"} value={state.token} />
                </div>
